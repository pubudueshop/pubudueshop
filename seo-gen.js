                    ...
                    <div class="share-section mt-6 pt-4 border-t border-gray-100">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex gap-2">
                                <button onclick="var btn=this; navigator.clipboard.writeText(window.location.href).then(function(){var orig=btn.innerHTML; btn.innerHTML='<i class=\'fas fa-check\'></i> Copied!'; setTimeout(function(){btn.innerHTML=orig;},2000);})" class="px-4 py-2 bg-gray-50 hover:bg-gray-100 rounded-lg text-xs font-bold text-gray-600 border border-gray-100 transition-all flex items-center gap-1">
                                    <i class="fas fa-link"></i> Copy
                                </button>
                                <button onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent(window.location.href), '_blank', 'noopener,noreferrer')" class="px-4 py-2 bg-blue-50 hover:bg-blue-100 rounded-lg text-xs font-bold text-blue-600 border border-blue-100 transition-all flex items-center gap-1">
                                    <i class="fab fa-facebook"></i> Facebook
                                </button>
                                <button onclick="window.open('https://api.whatsapp.com/send?text=' + encodeURIComponent('Check out this premium component at Pubudu Electronics:\n*' + '${cleanTitle.replace(/'/g, "\\'")}' + '*\n\nLink: ' + window.location.href), '_blank', 'noopener,noreferrer')" class="px-4 py-2 bg-green-50 hover:bg-green-100 rounded-lg text-xs font-bold text-green-600 border border-green-100 transition-all flex items-center gap-1">
